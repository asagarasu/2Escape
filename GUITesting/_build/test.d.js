...
(function(joo_global_object)
   {"use strict";
    ...
    var
     ...
     _d_=caml_new_string("table"),
     _c_=caml_new_string("img"),
     _b_=caml_new_string("div"),
     _e_=[0,caml_new_string("test.ml"),8,20];
    ...
    if(body == no_handler)throw [0,Assert_failure,_e_];
    var
     div=unsafeCreateElement(doc,_b_),
     style=
     ...
     {var tr=m.insertRow(-1),x=0;
      for(;;)
       {var td=tr.insertCell(-1);
        ...
        var img=unsafeCreateElement(doc,_c_);
        img.src = "boulder.png";
        appendChild(td,img);
        appendChild(tr,td);
        var _g_=x + 1 | 0;
        if(24 !== x){var x=_g_;continue}
        appendChild(m,tr);
        var _f_=y + 1 | 0;
        if(10 !== y){var y=_f_;continue a}
        appendChild(div,m);
        body.style.cssText
        =
